(function (root, factory) {
    if (typeof exports === 'object') {
        ...
        // like Node.
        module.exports = factory(require('./jQueryShim.js'));
    ...
    function Draggable(element, options) {
        ...
        $.extend(me, {
            ...
            handlers: {
                ...
                start: env.touch ? { touchstart: start } : { mousedown: start },

                move: env.touch ? { touchmove: drag, touchend: stop } : { mousemove: drag, mouseup: stop }
